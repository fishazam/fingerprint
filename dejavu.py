...
from dejavu.recognize import SpectrometerRecognizer
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="Fish Fingerprint Library",
    ...
    if args.fingerprint:
        ...
        if source in ('spec', 'spectrometer'):
            song = djv.recognize(SpectrometerRecognizer, seconds=opt_arg)
        elif source == 'file':
